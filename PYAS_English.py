...
"你確定要修復系統權限嗎?":"Are you sure you want to fix system permissions?",
"修復完成!":"Repair complete!",
"完成":'Finish',
"你確定要修復系統檔案嗎?":"Are you sure you want to repair the system files?",
"修復系統檔案":'Repair System Files',
"錯誤":"error",
"修復失敗":"Repair failed",
'清理系統檔案':'Clean up system files',
"你確定要清理系統檔案嗎?":"Are you sure you want to clean the system files?",
"清理完成":"Cleanup complete",
"清理失敗":"Cleanup failed",
"啟用安全模式":"Enable safe mode",
"你確定啟用安全模式嗎?":"Are you sure you enable safe mode?",
"使用該選項後需要重啟，現在要重啟嗎?":"A reboot is required after using this option, do you want to reboot now?",
"啟用失敗":"Enable failed",
'禁用安全模式':'Disable safe mode',
"你確定禁用安全模式嗎?":"Are you sure you want to disable Safe Mode?",
"禁用失敗":"Disable failed",
"刪除檔案":"Delete file",
"你確定刪除該檔案嗎?":"Are you sure you want to delete this file?",
"刪除成功":"Successfully deleted",
"刪除失敗":"Failed to delete",
"運行成功":"Run successfully",
"不是有效命令":"Not a valid command",
"你輸入了錯誤的HEKY":"You entered the wrong HEKY",
"警告":"Warning",
"成功的創建或修改註冊表值":"Successfully created or modified registry value",
"分析EXE函數":"Analyze EXE Functions",
"分析EXE哈希值":"Analyze EXE hashes",
"分析EXE位元":"Analyze EXE Bits",
'尋找結果:':'Find result:',
'正在尋找:':'Searching:',
'找到檔案:':'File found:',
'創建日期:':'Created Date:',
"你確定要修改用戶密碼嗎?":"Are you sure you want to change the user password?",
"IP查詢":"IP query",
"您的ip地址為:{}":"Your ip address is: {}",
"你確定要重置網路配置嗎?":"Are you sure you want to reset the network configuration?",
"重置網路配置成功":"Reset network configuration successful",
"設定":"Setting",
"關於":"About",
"結束進程":"End process",
"啟用該選項可以實時監控系統的惡意軟體並清除(需4GB以上的記憶體)":"Enable this option to monitor and remove malware in the system in real time (requires more than 4GB of memory)",
