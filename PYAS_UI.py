...
# Form implementation generated from reading ui file 'MainUI copy 2.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Show_Virus_Scan_Progress_Bar = QtWidgets.QWidget(self.Setting_widget)
        self.Show_Virus_Scan_Progress_Bar.setGeometry(QtCore.QRect(20, 50, 791, 101))
        self.Show_Virus_Scan_Progress_Bar.setAcceptDrops(False)
        self.Show_Virus_Scan_Progress_Bar.setAutoFillBackground(False)
        self.Show_Virus_Scan_Progress_Bar.setObjectName("Show_Virus_Scan_Progress_Bar")
        self.Show_Virus_Scan_Progress_Bar_title = QtWidgets.QLabel(self.Show_Virus_Scan_Progress_Bar)
        self.Show_Virus_Scan_Progress_Bar_title.setGeometry(QtCore.QRect(20, 10, 351, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(18)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        self.Show_Virus_Scan_Progress_Bar_title.setFont(font)
        self.Show_Virus_Scan_Progress_Bar_title.setStyleSheet("color: rgb(70,70,70);")
        self.Show_Virus_Scan_Progress_Bar_title.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.Show_Virus_Scan_Progress_Bar_title.setObjectName("Show_Virus_Scan_Progress_Bar_title")
        self.Show_Virus_Scan_Progress_Bar_illustrate = QtWidgets.QLabel(self.Show_Virus_Scan_Progress_Bar)
        self.Show_Virus_Scan_Progress_Bar_illustrate.setGeometry(QtCore.QRect(20, 50, 431, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        self.Show_Virus_Scan_Progress_Bar_illustrate.setFont(font)
        self.Show_Virus_Scan_Progress_Bar_illustrate.setStyleSheet("color: rgb(70,70,70);")
        self.Show_Virus_Scan_Progress_Bar_illustrate.setScaledContents(False)
        self.Show_Virus_Scan_Progress_Bar_illustrate.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.Show_Virus_Scan_Progress_Bar_illustrate.setWordWrap(True)
        self.Show_Virus_Scan_Progress_Bar_illustrate.setObjectName("Show_Virus_Scan_Progress_Bar_illustrate")
        self.Show_Virus_Scan_Progress_Bar_switch_Button = QtWidgets.QPushButton(self.Show_Virus_Scan_Progress_Bar)
        self.Show_Virus_Scan_Progress_Bar_switch_Button.setGeometry(QtCore.QRect(680, 30, 91, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Show_Virus_Scan_Progress_Bar_switch_Button.sizePolicy().hasHeightForWidth())
        self.Show_Virus_Scan_Progress_Bar_switch_Button.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        self.Show_Virus_Scan_Progress_Bar_switch_Button.setFont(font)
        self.Show_Virus_Scan_Progress_Bar_switch_Button.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.Show_Virus_Scan_Progress_Bar_switch_Button.setStyleSheet("QPushButton\n"
"{\n"
"    border:none;\n"
...
"}")
        self.Show_Virus_Scan_Progress_Bar_switch_Button.setIconSize(QtCore.QSize(16, 16))
        self.Show_Virus_Scan_Progress_Bar_switch_Button.setCheckable(False)
        self.Show_Virus_Scan_Progress_Bar_switch_Button.setObjectName("Show_Virus_Scan_Progress_Bar_switch_Button")
        self.Setting_Back = QtWidgets.QPushButton(self.Setting_widget)
        self.Setting_Back.setGeometry(QtCore.QRect(20, 10, 81, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icon/Icon/exit2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Setting_Back.setIcon(icon)
        ...
        self.Language_title.setGeometry(QtCore.QRect(20, 10, 161, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(18)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Language_illustrate.setGeometry(QtCore.QRect(20, 50, 181, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Language_Choose_widget.setGeometry(QtCore.QRect(490, 10, 291, 81))
        font = QtGui.QFont()
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        self.Language_Choose_widget.setFont(font)
        self.Language_Choose_widget.setObjectName("Language_Choose_widget")
        self.Language_Traditional_Chinese = QtWidgets.QRadioButton(self.Language_Choose_widget)
        self.Language_Traditional_Chinese.setGeometry(QtCore.QRect(10, 20, 91, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        ...
        self.Language_Simplified_Chinese = QtWidgets.QRadioButton(self.Language_Choose_widget)
        self.Language_Simplified_Chinese.setGeometry(QtCore.QRect(110, 20, 91, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Languahe_English = QtWidgets.QRadioButton(self.Language_Choose_widget)
        self.Languahe_English.setGeometry(QtCore.QRect(210, 20, 81, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        ...
        self.Theme_title.setGeometry(QtCore.QRect(20, 10, 291, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(18)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Theme_illustrate.setGeometry(QtCore.QRect(20, 50, 291, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Language_Choose_widget_2.setGeometry(QtCore.QRect(490, 0, 301, 101))
        font = QtGui.QFont()
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        self.Language_Choose_widget_2.setFont(font)
        self.Language_Choose_widget_2.setObjectName("Language_Choose_widget_2")
        self.Theme_White = QtWidgets.QRadioButton(self.Language_Choose_widget_2)
        self.Theme_White.setGeometry(QtCore.QRect(10, 10, 91, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Theme_Black = QtWidgets.QRadioButton(self.Language_Choose_widget_2)
        self.Theme_Black.setGeometry(QtCore.QRect(110, 10, 91, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Theme_Pink = QtWidgets.QRadioButton(self.Language_Choose_widget_2)
        self.Theme_Pink.setGeometry(QtCore.QRect(210, 10, 91, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Theme_Red = QtWidgets.QRadioButton(self.Language_Choose_widget_2)
        self.Theme_Red.setGeometry(QtCore.QRect(110, 50, 91, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Theme_Green = QtWidgets.QRadioButton(self.Language_Choose_widget_2)
        self.Theme_Green.setGeometry(QtCore.QRect(210, 50, 91, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Theme_Blue = QtWidgets.QRadioButton(self.Language_Choose_widget_2)
        self.Theme_Blue.setGeometry(QtCore.QRect(10, 50, 91, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        ...
        self.More_Tools_Back.setGeometry(QtCore.QRect(10, 10, 81, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}\n"
"")
        self.More_Tools_Back.setIcon(icon)
        ...
        self.verticalLayoutWidget_7.setGeometry(QtCore.QRect(19, 59, 631, 421))
...
"}")
        ...
        self.Decrypt_Text_Button = QtWidgets.QPushButton(self.verticalLayoutWidget_7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Decrypt_Text_Button.sizePolicy().hasHeightForWidth())
        self.Decrypt_Text_Button.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        self.Decrypt_Text_Button.setFont(font)
        self.Decrypt_Text_Button.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.Decrypt_Text_Button.setStyleSheet("QPushButton\n"
"{\n"
"    border:none;\n"
"    background-color:rgba(20,20,20,30);\n"
"    border-radius: 15px;\n"
...
"    background-color:rgba(20,20,20,70);\n"
"}")
        self.Decrypt_Text_Button.setIconSize(QtCore.QSize(16, 16))
        self.Decrypt_Text_Button.setCheckable(False)
        self.Decrypt_Text_Button.setObjectName("Decrypt_Text_Button")
        self.More_Tools_verticalLayout.addWidget(self.Decrypt_Text_Button)
...
"}")
        ...
        self.Encryption_Text_Back.setGeometry(QtCore.QRect(10, 10, 81, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}\n"
"")
        self.Encryption_Text_Back.setIcon(icon)
        ...
        self.Encryption_Text_Run_Button.setGeometry(QtCore.QRect(420, 400, 91, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.Encryption_Text_input.setGeometry(QtCore.QRect(20, 100, 311, 291))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Encryption_Text_output.setGeometry(QtCore.QRect(340, 100, 311, 291))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Encryption_Text_Password_input.setGeometry(QtCore.QRect(110, 400, 191, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Encryption_Text_title2.setGeometry(QtCore.QRect(340, 60, 261, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.Encryption_Text_Password_title.setGeometry(QtCore.QRect(20, 400, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.Encryption_Text_title.setGeometry(QtCore.QRect(20, 60, 201, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.Decrypt_Text_Run_Button.setGeometry(QtCore.QRect(320, 400, 91, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.Real_time_Protection_widget.setGeometry(QtCore.QRect(30, 20, 611, 101))
        ...
        self.Protection_title.setGeometry(QtCore.QRect(20, 10, 351, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(18)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Protection_illustrate.setGeometry(QtCore.QRect(20, 50, 421, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Protection_switch_Button.setGeometry(QtCore.QRect(490, 35, 91, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.Virus_Scan_title.setGeometry(QtCore.QRect(45, 40, 131, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(18)
...
"}")
        ...
        self.Virus_Scan_output.setGeometry(QtCore.QRect(45, 170, 581, 291))
...
"}")
        ...
        self.Virus_Scan_ProgressBar.setGeometry(QtCore.QRect(45, 157, 581, 12))
        ...
        self.State_title.setGeometry(QtCore.QRect(164, 240, 341, 51))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        ...
        self.State_icon.setGeometry(QtCore.QRect(265, 90, 141, 131))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(1)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.State_output.setGeometry(QtCore.QRect(105, 320, 461, 121))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        self.State_output.setFont(font)
        self.State_output.setTextInteractionFlags(QtCore.Qt.NoTextInteraction)
        self.State_output.setObjectName("State_output")
        self.State_log = QtWidgets.QLabel(self.State_widget)
        self.State_log.setGeometry(QtCore.QRect(95, 290, 61, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.State_log.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.Change_Users_Password_Back.setGeometry(QtCore.QRect(10, 10, 81, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}\n"
"")
        self.Change_Users_Password_Back.setIcon(icon)
        ...
        self.Change_Users_Password_New_Password_input.setGeometry(QtCore.QRect(30, 200, 161, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        ...
        self.Change_Users_Password_New_Password_title.setGeometry(QtCore.QRect(30, 160, 141, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.Change_Users_Password_User_Name_title.setGeometry(QtCore.QRect(30, 80, 161, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.Change_Users_Password_User_Name_input.setGeometry(QtCore.QRect(30, 120, 161, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        ...
        self.Change_Users_Password_Run_Button.setGeometry(QtCore.QRect(210, 140, 81, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.System_Info_Back.setGeometry(QtCore.QRect(10, 10, 81, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}\n"
"")
        self.System_Info_Back.setIcon(icon)
        ...
        self.System_Info_View.setGeometry(QtCore.QRect(20, 60, 631, 411))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Develop_Tools_Back.setGeometry(QtCore.QRect(10, 10, 81, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}\n"
"")
        self.Develop_Tools_Back.setIcon(icon)
        ...
        self.verticalLayoutWidget_6.setGeometry(QtCore.QRect(20, 60, 631, 421))
...
"}")
        ...
        self.Look_for_File_Back.setGeometry(QtCore.QRect(10, 10, 81, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}\n"
"")
        self.Look_for_File_Back.setIcon(icon)
        ...
        self.Look_for_File_Run_Button.setGeometry(QtCore.QRect(550, 70, 101, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.Look_for_File_input.setGeometry(QtCore.QRect(20, 70, 521, 31))
        ...
        self.Look_for_File_output.setGeometry(QtCore.QRect(20, 120, 631, 351))
        ...
        self.Privacy_Tools_Back.setGeometry(QtCore.QRect(10, 10, 81, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}\n"
"")
        self.Privacy_Tools_Back.setIcon(icon)
        ...
        self.verticalLayoutWidget_5.setGeometry(QtCore.QRect(20, 60, 631, 81))
...
"}")
        ...
        self.About_Back.setGeometry(QtCore.QRect(10, 10, 81, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"")
        ...
        self.PYAS_Version.setGeometry(QtCore.QRect(20, 60, 141, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(14)
        font.setBold(False)
        ...
        self.GUI_Made_title.setGeometry(QtCore.QRect(20, 110, 101, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(13)
        font.setBold(False)
        ...
        self.GUI_Made_Name.setGeometry(QtCore.QRect(130, 110, 151, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(13)
        font.setBold(False)
        ...
        self.Core_Made_title.setGeometry(QtCore.QRect(20, 160, 101, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(13)
        font.setBold(False)
        ...
        self.Core_Made_Name.setGeometry(QtCore.QRect(130, 160, 151, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(13)
        font.setBold(False)
        ...
        self.Testers_title.setGeometry(QtCore.QRect(20, 210, 101, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(13)
        font.setBold(False)
        ...
        self.Testers_Name.setGeometry(QtCore.QRect(130, 210, 300, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(13)
        font.setBold(False)
        ...
        self.PYAS_URL_title.setGeometry(QtCore.QRect(20, 260, 181, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(13)
        font.setBold(False)
        ...
        self.PYAS_URL.setGeometry(QtCore.QRect(130, 260, 321, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(13)
        font.setBold(False)
        ...
        self.PYAS_CopyRight.setGeometry(QtCore.QRect(20, 450, 261, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(13)
        font.setBold(False)
        ...
        self.PYAS_CopyRight.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.PYAS_CopyRight.setObjectName("PYAS_CopyRight")
        self.PYAE_Version = QtWidgets.QLabel(self.About_widget)
        self.PYAE_Version.setGeometry(QtCore.QRect(160, 60, 121, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(14)
        font.setBold(False)
        ...
        self.License_terms.setGeometry(QtCore.QRect(20, 350, 621, 101))
        ...
        self.License_terms_title.setGeometry(QtCore.QRect(20, 310, 171, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(13)
        font.setBold(False)
        ...
        self.Customize_REG_Command_Back.setGeometry(QtCore.QRect(10, 10, 81, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}\n"
"")
        self.Customize_REG_Command_Back.setIcon(icon)
        ...
        self.Value_Path_title.setGeometry(QtCore.QRect(30, 70, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.Value_Name_title.setGeometry(QtCore.QRect(30, 110, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.Value_Type_title.setGeometry(QtCore.QRect(30, 150, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.Value_Data_title.setGeometry(QtCore.QRect(30, 190, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.Value_Path_input.setGeometry(QtCore.QRect(140, 70, 221, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Value_Type_input.setGeometry(QtCore.QRect(140, 150, 221, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Value_Name_input.setGeometry(QtCore.QRect(140, 110, 221, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Value_Data_input.setGeometry(QtCore.QRect(140, 190, 221, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Customize_REG_Command_Run_Button.setGeometry(QtCore.QRect(380, 150, 91, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.Value_HEKY_title.setGeometry(QtCore.QRect(30, 230, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.Value_HEKY_input.setGeometry(QtCore.QRect(140, 230, 221, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
...
"}")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icon/Icon/X.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icon/Icon/minimizeIcon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.Window_title.setGeometry(QtCore.QRect(10, 0, 300, 41))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(14)
        font.setBold(False)
...
"}")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icon/Icon/Menu.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.Process_Tools_Back.setGeometry(QtCore.QRect(10, 10, 81, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}\n"
"")
        self.Process_Tools_Back.setIcon(icon)
        ...
        self.Process_list.setGeometry(QtCore.QRect(20, 60, 631, 381))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
...
"}")
        ...
        self.Process_Total_title.setGeometry(QtCore.QRect(20, 445, 111, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.Process_Total_View.setGeometry(QtCore.QRect(130, 450, 121, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(20, 60, 631, 421))
...
"}")
        ...
        self.System_Tools_Back.setGeometry(QtCore.QRect(10, 10, 81, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}\n"
"")
        self.System_Tools_Back.setIcon(icon)
        ...
        self.Analyze_EXE_Back.setGeometry(QtCore.QRect(10, 10, 81, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}\n"
"")
        self.Analyze_EXE_Back.setIcon(icon)
        ...
        self.Analyze_EXE_Output.setGeometry(QtCore.QRect(20, 60, 631, 411))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Customize_CMD_Command_Back.setGeometry(QtCore.QRect(10, 10, 81, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}\n"
"")
        self.Customize_CMD_Command_Back.setIcon(icon)
        ...
        self.Customize_CMD_Command_lineEdit.setGeometry(QtCore.QRect(20, 80, 521, 31))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.Customize_CMD_Command_Run_Button.setGeometry(QtCore.QRect(550, 80, 101, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.Customize_CMD_Command_output.setGeometry(QtCore.QRect(20, 140, 631, 321))
        font = QtGui.QFont()
        ...
        self.Customize_CMD_Command_output_title.setGeometry(QtCore.QRect(20, 120, 281, 16))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(20, 60, 631, 421))
...
"}")
        ...
        self.More_Tools_Back_Button.setGeometry(QtCore.QRect(10, 10, 81, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Show_Virus_Scan_Progress_Bar_title.setText(_translate("MainWindow", "顯示病毒掃描進度條"))
        self.Show_Virus_Scan_Progress_Bar_illustrate.setText(_translate("MainWindow", "開啟此選項後可以知道掃描的進度(會增加初始化時間)"))
        self.Show_Virus_Scan_Progress_Bar_switch_Button.setText(_translate("MainWindow", "關閉"))
        ...
        self.Decrypt_Text_Button.setText(_translate("MainWindow", "解密文字"))
        ...
        self.Protection_title.setText(_translate("MainWindow", "實時防護"))
        self.Protection_illustrate.setText(_translate("MainWindow", "啟用該選項可以實時監控系統的惡意軟體並清除(需4GB以上的記憶體)"))
        self.Protection_switch_Button.setText(_translate("MainWindow", "關閉"))
        ...
        self.PYAS_Version.setText(_translate("MainWindow", "PYAS  v2.2.0"))
        ...
        self.PYAS_URL_title.setText(_translate("MainWindow", "PYAS官方網站:"))
        ...
        self.PYAS_CopyRight.setText(_translate("MainWindow", "Copyright© 2020-2022 PYAS"))
        self.PYAE_Version.setText(_translate("MainWindow", "PYAE v1.2.3"))
        ...
        self.Window_title.setText(_translate("MainWindow", "PYAS  v2.2.0"))
