...
"尚未啟用實時防護":"Real-time Protect is not enabled",
...
"您輸入了錯誤的TYPE":"You entered the wrong TYPE",
"警告":"Warning",
...
'成功攔截惡意軟體: ':'Malware blocking success: ',
'成功修復註冊表: ':'Repair registry success: ',
'成功修復引導扇區: PhysicalDrive0':'Repair boot sector success: PhysicalDrive0',
'正在掃描檔案安全性: ':'Scanning file security: ',
'惡意軟體攔截失敗: ':'Malware blocking failed: ',
